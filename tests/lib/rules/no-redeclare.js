...
ruleTester.run("no-redeclare", rule, {
    valid: [
        ...
        { code: "var Object = 0;", options: [{builtinGlobals: true}], parserOptions: { ecmaVersion: 6 } },
        { code: "var Object = 0;", options: [{builtinGlobals: true}], parserOptions: { parserOptions: { ecmaVersion: 6 } } },
        { code: "var top = 0;", env: {browser: true} },
        { code: "var top = 0;", options: [{builtinGlobals: true}] },
        { code: "var top = 0;", options: [{builtinGlobals: true}], env: {browser: true}, parserOptions: { ecmaVersion: 6 } },
        { code: "var top = 0;", options: [{builtinGlobals: true}], env: {browser: true}, parserOptions: { parserOptions: { ecmaVersion: 6 } } }
    ],
    invalid: [
        { code: "var a = 3; var a = 10;", parserOptions: { parserOptions: { ecmaVersion: 6 } }, errors: [{ message: "\"a\" is already defined", type: "Identifier"}] },
